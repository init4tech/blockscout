...
config :explorer, Oban, enabled: true

config :explorer, Explorer.Chain.CsvExport,
  async?: ConfigHelper.parse_bool_env_var("CSV_EXPORT_ASYNC_ENABLED"),
  max_pending_tasks_per_ip: ConfigHelper.parse_integer_env_var("CSV_EXPORT_ASYNC_MAX_PENDING_TASKS_PER_IP", 3),
  chunk_size: ConfigHelper.parse_integer_env_var("CSV_EXPORT_ASYNC_CHUNK_SIZE", 26_214_400),
